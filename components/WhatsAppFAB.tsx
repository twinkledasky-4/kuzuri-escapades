...
export const WhatsAppFAB: React.FC = () => {
  ...
  return (
    <a 
      ...
      className="fixed bottom-6 left-6 rounded-full shadow-2xl transition-all duration-500 transform hover:scale-110 active:scale-90 z-[900] flex items-center justify-center border-2 border-white/20 group animate-fab-float"
      style={{ 
    ...
    >
      ...
      {/* Visual pulse indicator for interactivity */}
