...
export const BentoGallery: React.FC = () => {
  ...
  return (
    <section className="py-24 md:py-48 bg-[#1A1412] border-t border-white/5 px-6" aria-labelledby="gallery-title">
      <div className="container mx-auto max-w-[1700px]">
        <div className="mb-32 text-center reveal-trigger">
          <p className="text-[#D4AF37] uppercase tracking-[1em] text-[10px] mb-8 font-bold">VISUAL ARCHIVE</p>
          <h2 id="gallery-title" className="text-5xl md:text-8xl font-serif font-bold text-[#D4AF37] mb-12 tracking-tighter uppercase">
            Bespoke <span className="italic font-light">Fragments.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {galleryItems.map((item) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-end p-12 text-center transform translate-y-4 group-hover:translate-y-0 transition-all duration-700">
                <p className="text-[#D4AF37] font-serif text-3xl md:text-4xl font-bold tracking-tight mb-4 italic leading-tight">
                  {item.title}
                </p>
                <div className="w-12 h-[2px] bg-[#D4AF37] mb-6 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700" />
                <p className="text-white text-[10px] uppercase tracking-[0.5em] font-black opacity-100 mb-2">
                  NATIVE NARRATIVE
                </p>
                
                {/* Visual Serial ID */}
                <div className="absolute top-8 left-8 text-white/40 text-[9px] uppercase tracking-[0.6em] font-black border-l border-white/20 pl-4">
