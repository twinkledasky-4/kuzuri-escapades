...
import { AppSection, Tour } from './types';
...
import { WhyKuzuri } from './components/WhyKuzuri';
    ...
    <div className="relative min-h-screen bg-white selection:bg-[#002d04] selection:text-[#d4af37]">
      ...
      <main id="main-content" role="main">
          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-24">
            <div className="max-w-screen-2xl mx-auto flex flex-col lg:flex-row gap-16 md:gap-24 lg:gap-48 items-center">
              <div className="w-full lg:w-1/2 overflow-hidden reveal-image aspect-[4/5] shadow-[0_60px_120px_-30px_rgba(0,0,0,0.12)]">
                <img 
                  src="https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?auto=format&fit=crop&q=85&w=1200" 
        ...
        <section className="relative h-[60vh] md:h-[95vh] w-full overflow-hidden" aria-hidden="true">
          <img 
            src="https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?auto=format&fit=crop&q=80&w=2400" 
